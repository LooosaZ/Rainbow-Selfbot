...
var ChannelApi = /** @class */ (function (_super) {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._client.callApi({ url: "channels/" + twitch_common_1.extractUserId(user) })];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        channelId = twitch_common_1.extractUserId(channel);
                        userId = twitch_common_1.extractUserId(byUser);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
    ...
    ChannelApi = tslib_1.__decorate([
        ...
        twitch_common_1.rtfm('twitch', 'ChannelApi')
    ], ChannelApi);
    return ChannelApi;
}(BaseApi_1.BaseApi));
