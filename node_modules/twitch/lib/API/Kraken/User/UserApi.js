...
var UserApi = /** @class */ (function (_super) {
    ...
    UserApi.prototype.getUser = function (userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._client.callApi({ url: "users/" + twitch_common_1.extractUserId(userId) })];
                    case 1:
                        userData = _a.sent();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        userId = twitch_common_1.extractUserId(user);
                        channelId = twitch_common_1.extractUserId(toChannel);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userId = twitch_common_1.extractUserId(user);
                        userIdToBlock = twitch_common_1.extractUserId(userToBlock);
                        return [4 /*yield*/, this._client.callApi({
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userId = twitch_common_1.extractUserId(user);
                        userIdToUnblock = twitch_common_1.extractUserId(userToUnblock);
                        return [4 /*yield*/, this._client.callApi({
    ...
    UserApi = tslib_1.__decorate([
        ...
        twitch_common_1.rtfm('twitch', 'UserApi')
    ], UserApi);
    return UserApi;
}(BaseApi_1.BaseApi));
